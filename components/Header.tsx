...
const Header = () => {
    return (
        <header className="flex flex-row flex-wrap justify-between items-center border-b-2 border-gray-100 w-full min-h-[8vh] px-16 py-6">
            <h1 className="text-lg py-2 tablet:text-xl desktop:text-2xl">Where in the world?</h1>
